...
<html>
	<head>
		<title>testhubc.localhubc.com server is running</title>
	...
	<main>
	    ...
	    <section>
		<div>
		<h2>testhubc.localhubc.com server is running</h2>

		<p><b>testhubc</b>.localhubc.com server is running.If you are seeing this page, you can now write files to the <code>websites/default/public</code> directory and they will be accessible.</p>
		</div>
